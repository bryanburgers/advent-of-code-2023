(module
    ...
    (import "dbg" "inspect:two_match" (func $dbg.two_match (param i32 i32 i32) (result i32 i32 i32)))
    (import "dbg" "inspect:classify_start" (func $dbg.classify_start (param i32 i32 i32 i32 i32) (result i32 i32 i32 i32 i32)))
    ...
    (func $parse_line
        ...
        ;; To sort ties, we need to sort by the first card, then the second,
        ;; then the third, etc.
        ;; If we store them in the right way (as an i64 le) then we can just
        ;; sort a single number. That just means we need to store these in the
        ;; right spots.
        (i32.store8
    ...
    (func $classify_hand
        ...
        ;; (drop (drop (drop (drop (drop (call $dbg.classify_start (local.get 0) (local.get 1) (local.get 2) (local.get 3) (local.get 4)))))))

        (block $block
            (local.set $result (i32.const 6))
            (call $is_five_of_a_kind (local.get 0) (local.get 1) (local.get 2) (local.get 3) (local.get 4))
            br_if $block

            (local.set $result (i32.const 5))
            (call $is_four_of_a_kind (local.get 0) (local.get 1) (local.get 2) (local.get 3) (local.get 4))
            br_if $block

            (local.set $result (i32.const 4))
            (call $is_full_house (local.get 0) (local.get 1) (local.get 2) (local.get 3) (local.get 4))
            br_if $block

            (local.set $result (i32.const 3))
            (call $is_three_of_a_kind (local.get 0) (local.get 1) (local.get 2) (local.get 3) (local.get 4))
            br_if $block

            (local.set $result (i32.const 2))
            (call $is_two_pair (local.get 0) (local.get 1) (local.get 2) (local.get 3) (local.get 4))
            br_if $block

            (local.set $result (i32.const 1))
            (call $is_one_pair (local.get 0) (local.get 1) (local.get 2) (local.get 3) (local.get 4))
            br_if $block
    ...
    (func $two_match (param i32 i32) (result i32)
        (call $card_matches (local.get 0) (local.get 1))
    )

    (func $three_match (param i32 i32 i32) (result i32)
        (call $two_match (local.get 1) (local.get 2))
        (call $two_match (local.get 0) (local.get 2))
        (call $two_match (local.get 0) (local.get 1))
        i32.and
        i32.and
    )

    (func $four_match (param i32 i32 i32 i32) (result i32)
        (call $three_match (local.get 1) (local.get 2) (local.get 3))
        (call $three_match (local.get 0) (local.get 2) (local.get 3))
        (call $three_match (local.get 0) (local.get 1) (local.get 3))
        (call $three_match (local.get 0) (local.get 1) (local.get 2))
        i32.and
        i32.and
        i32.and
    )

    (func $five_match (param i32 i32 i32 i32 i32) (result i32)
        (call $four_match (local.get 1) (local.get 2) (local.get 3) (local.get 4))
        (call $four_match (local.get 0) (local.get 2) (local.get 3) (local.get 4))
        (call $four_match (local.get 0) (local.get 1) (local.get 3) (local.get 4))
        (call $four_match (local.get 0) (local.get 1) (local.get 2) (local.get 4))
        (call $four_match (local.get 0) (local.get 1) (local.get 2) (local.get 3))
        i32.and
        i32.and
        i32.and
        i32.and
    ...
    (func $is_five_of_a_kind (param i32 i32 i32 i32 i32) (result i32)
        (call $five_match
            (local.get 0)
            (local.get 1)
            (local.get 2)
    ...
    (func $is_four_of_a_kind (param i32 i32 i32 i32 i32) (result i32)
        (call $four_match (local.get 1) (local.get 2) (local.get 3) (local.get 4))
        (call $four_match (local.get 0) (local.get 2) (local.get 3) (local.get 4))
        (call $four_match (local.get 0) (local.get 1) (local.get 3) (local.get 4))
        (call $four_match (local.get 0) (local.get 1) (local.get 2) (local.get 4))
    ...
    (func $is_full_house (param i32 i32 i32 i32 i32) (result i32)
        i32.const 0

        (call $three_match (local.get 2) (local.get 3) (local.get 4))
        (call $two_match (local.get 0) (local.get 1))
        i32.and
        i32.or

        (call $three_match (local.get 1) (local.get 3) (local.get 4))
        (call $two_match (local.get 0) (local.get 2))
        i32.and
        i32.or

        (call $three_match (local.get 1) (local.get 2) (local.get 4))
        (call $two_match (local.get 0) (local.get 3))
        i32.and
        i32.or

        (call $three_match (local.get 1) (local.get 2) (local.get 3))
        (call $two_match (local.get 0) (local.get 4))
        i32.and
        i32.or

        (call $three_match (local.get 0) (local.get 3) (local.get 4))
        (call $two_match (local.get 1) (local.get 2))
        i32.and
        i32.or

        (call $three_match (local.get 0) (local.get 2) (local.get 4))
        (call $two_match (local.get 1) (local.get 3))
        i32.and
        i32.or

        (call $three_match (local.get 0) (local.get 2) (local.get 3))
        (call $two_match (local.get 1) (local.get 4))
        i32.and
        i32.or

        (call $three_match (local.get 0) (local.get 1) (local.get 4))
        (call $two_match (local.get 2) (local.get 3))
        i32.and
        i32.or

        (call $three_match (local.get 0) (local.get 1) (local.get 3))
        (call $two_match (local.get 2) (local.get 4))
        i32.and
        i32.or

        (call $three_match (local.get 0) (local.get 1) (local.get 2))
        (call $two_match (local.get 3) (local.get 4))
        i32.and
        i32.or
        ;; call $dbg.is_full_house
    )

    (func $is_three_of_a_kind (param i32 i32 i32 i32 i32) (result i32)
        i32.const 0
    ...
    (func $is_two_pair (param i32 i32 i32 i32 i32) (result i32)
        i32.const 0
    ...
    (func $is_one_pair (param i32 i32 i32 i32 i32) (result i32)
        i32.const 0
        (call $two_match (local.get 0) (local.get 1))
        i32.or
