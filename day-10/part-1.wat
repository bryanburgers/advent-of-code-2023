(module
    ...
    (func $main (result i32)
        ...
        ;; counter is how many steps it takes to get back to the start.
        ;; we want how many steps it takes to get half-way.
        ;; so divide by 2.
    ...
    (func $find_starting_point (result i64)
        ...
        ;; If the width is > 5, then use the input. Otherwise use the example.
        (i32.gt_u
            (global.get $width)
            (i32.const 5))
    ...
    (func $find_starting_direction (result i32)
        ...
        ;;
        ;; The example starts going N→S or W→E.
